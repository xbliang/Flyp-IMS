						...
						<tbody>
							...
							<tr>
								<td style="padding: 10px;" valign="top" align="left">
									<!-- -------------------- --> <!-- Begin Page Content -->
									<form> 
										<button name="MostActive">Most Active Users</button>
										<button name="LeastActive">Least Active Users</button> <br>
										<button name="UsersExpiring">Users about to expire</button> <br>
										<button name="CancelledSubscriptions">Recently Cancelled Subscriptions</button>
									</form>
									<!--  End Page Content  -->
									<!-- ------------------ -->
