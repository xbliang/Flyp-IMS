							...
							<tr>
								<td style="padding: 10px;" valign="top" align="left">
									...
									<form action="search.jsp" method="POST">
										Native phone number:<br> <input type="text"
											name="phonenumber"> <br> Flyp Number:<br> <input
											type="text" name="flypnumber"> <br> Name of Flyp
										Number:<br> <input type="text" name="flypname"> <br>
